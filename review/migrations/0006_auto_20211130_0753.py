...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('review', '0005_remove_review_verified'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='likes', to='review.review', verbose_name='Review')),
            ],
        ),
    ]
